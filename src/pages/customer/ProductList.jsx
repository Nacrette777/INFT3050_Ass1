...
function ProductList() {
  ...
  // Products now come from the database instead of mockProducts.
  // catalogService converts the rows into the same flat shape the rest
  // of this component already expects, so nothing below here changes.
