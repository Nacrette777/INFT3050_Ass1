...
function Login() {
  ...
  async function handleSubmit(event) {
    ...
    // login() now queries the database, so it must be awaited.
    // Staff sign in against the User table, customers against Patrons.
    ...
    <section className="mg-auth">
      <div className="mg-auth-card">
        ...
        <div className="mg-demo">
          ...
          <br />
          Customer: <code>alice@test.com</code> / <code>Test123!</code>
          <br />
          Admin: <code>devadmin</code> / <code>Admin123!</code>
        </div>
      </div>
    </section>
  );
